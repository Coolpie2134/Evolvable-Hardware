"""
lut_evo/playback.py — continuous-time playback of a grown LUT array: the LUT
twin of nv_evo.playback.NervousPlayer, driving the asynchronous level-logic
engine (lut_evo.pulse.AsyncLutSim) from the same clickable pulse timeline.
...
from nv_evo.playback import AsyncPlayer, DEFAULT_DT, DEFAULT_HORIZON
