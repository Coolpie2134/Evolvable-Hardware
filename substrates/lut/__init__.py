...
four neighbours' binary outputs. The dynamics are ASYNCHRONOUS level logic
(lut_evo.pulse.AsyncLutSim): each cell is a logic element with a fixed
...
from .pulse import LutConfig, AsyncLutSim, run_lut
