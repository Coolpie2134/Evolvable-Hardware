...
# August 11, 2007
# Version "mhier1"
#   Generated from "multi9" and pieces of
#   "hierarch4".  Obtain the benefits of the
#   hierarchical growth without dealing with the
#   coderack model.  Uses (more or less) the
#   original lookup table model, but with wildcard
#   characters and "split operator" characters.
#   New method for handling the hierarchy using
#   "copy" characters.
#
# Python translation of mhier1.c
#
# NOTE: mhier1.c is byte-for-byte identical to multi9.c
# except for this header comment block -- the hierarchical
# wildcard/copy-character mechanism described above was
# evidently planned but not yet implemented in this
# revision of the C source. This translation therefore
# mirrors multi9.py exactly in its logic.
#------------------------------------------------------#
